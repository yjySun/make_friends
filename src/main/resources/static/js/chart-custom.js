  ...
  if(jQuery('#layout1-chart-01').length){
    ...
    if(jQuery('#layout1-chart-02').length){
      ...
      if (jQuery("#layout1-chart-07").length) {
        var hour0 = $("span[onlineHour=hour0]").attr("personCount");
        var hour1 = $("span[onlineHour=hour1]").attr("personCount");
        var hour2 = $("span[onlineHour=hour2]").attr("personCount");
        var hour3 = $("span[onlineHour=hour3]").attr("personCount");
        var hour4 = $("span[onlineHour=hour4]").attr("personCount");
        var hour5 = $("span[onlineHour=hour5]").attr("personCount");
        var hour6 = $("span[onlineHour=hour6]").attr("personCount");
        var hour7 = $("span[onlineHour=hour7]").attr("personCount");
        var hour8 = $("span[onlineHour=hour8]").attr("personCount");
        var hour9 = $("span[onlineHour=hour9]").attr("personCount");
        var hour10 = $("span[onlineHour=hour10]").attr("personCount");
        var hour11 = $("span[onlineHour=hour11]").attr("personCount");
        var hour12 = $("span[onlineHour=hour12]").attr("personCount");
        var hour13 = $("span[onlineHour=hour13]").attr("personCount");
        var hour14 = $("span[onlineHour=hour14]").attr("personCount");
        var hour15 = $("span[onlineHour=hour15]").attr("personCount");
        var hour16 = $("span[onlineHour=hour16]").attr("personCount");
        var hour17 = $("span[onlineHour=hour17]").attr("personCount");
        var hour18 = $("span[onlineHour=hour18]").attr("personCount");
        var hour19 = $("span[onlineHour=hour19]").attr("personCount");
        var hour20 = $("span[onlineHour=hour20]").attr("personCount");
        var hour21 = $("span[onlineHour=hour21]").attr("personCount");
        var hour22 = $("span[onlineHour=hour22]").attr("personCount");
        var hour23 = $("span[onlineHour=hour23]").attr("personCount");

        const options = {
          series: [{
            name: '最大同时在线人数',
            data: [hour0, hour1, hour2, hour3, hour4, hour5, hour6, hour7, hour8, hour9, hour10, hour11, hour12, hour13, hour14, hour15, hour16, hour17, hour18, hour19, hour20, hour21, hour22, hour23]
          }],
      ...
      if (jQuery("#layout1-chart04").length) {
        var Jan = $("span#month").attr("Jan");
        var Feb = $("span#month").attr("Feb");
        var Mar = $("span#month").attr("Mar");
        var Apr = $("span#month").attr("Apr");
        var May = $("span#month").attr("May");
        var Jun = $("span#month").attr("Jun");
        var Jul = $("span#month").attr("Jul");
        var Aug = $("span#month").attr("Aug");
        var Sept = $("span#month").attr("Sept");
        var Oct = $("span#month").attr("Oct");
        var Nov = $("span#month").attr("Nov");
        var Dec = $("span#month").attr("Dec");
